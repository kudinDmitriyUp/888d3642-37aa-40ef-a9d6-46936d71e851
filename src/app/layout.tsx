...
export const metadata: Metadata = {
  title: "Let's F*ck Around and Find Out | Adventure Travel",
  description: "Discover unexpected adventures and authentic travel experiences worldwide. Flexible itineraries, guided exploration, and real stories from real travelers.",
  keywords: ["adventure travel", "custom itineraries", "travel experiences", "off-the-beaten-path", "travel company"],
  metadataBase: new URL("https://letsfuckround.com"),
  alternates: {
    canonical: "https://letsfuckround.com"
  },
  openGraph: {
    title: "Let's F*ck Around and Find Out - Adventure Travel",
    description: "Discover unexpected adventures worldwide. Flexible itineraries designed for real explorers.",
    siteName: "Let's F*ck Around and Find Out",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1765894603250-gh8rqv1q.jpg",
  ...
  twitter: {
    ...
    description: "Discover authentic travel beyond the guidebook with flexible, customizable itineraries.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1765894603250-gh8rqv1q.jpg"]
  },
  robots: {
    index: true,
    follow: true
